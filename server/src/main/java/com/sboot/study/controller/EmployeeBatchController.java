...
import com.sboot.study.mapper.TbEmployeeMapper;
...
//      Connection con = null;
        try {
            ...
            final String querySql = "select * from tb_employee limit 0,20000";
            ...
            //获取连接
//          con = productJdbcTemplate.getDataSource().getConnection();
...
//          con.setAutoCommit(false);
            ...
            productJdbcTemplate.batchUpdate(updSql, new BatchPreparedStatementSetter() {
...
//          }
    ...
    public BaseResponse insertEmployeeByMybatis() {
        ...
        try {
            ...
            employeeMapper.insertByBatch(employeeList);
